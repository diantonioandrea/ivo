...
int main(int argc, char **argv) {
    ...
    // Output.
    std::ofstream output{"output/hSaturation_" + std::to_string(p) + "_" + std::to_string(q) + ".e21"};

    #ifndef NVERBOSE
    std::cout << "[Ivo] TEST, Testing space saturation\n" << std::endl;
    #else
    std::cout << "[Ivo] TEST, Testing space saturation" << std::endl;
    #endif
    ...
    diagrams.emplace_back("data/square/Square_4000.p2");
