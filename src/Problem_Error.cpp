...
namespace ivo {
     ...
     */
    Error::Error(const Mesh21 &mesh, const Vector<Real> &uh, const std::function<Real (Real, Real, Real)> &u, const std::function<std::array<Real, 2> (Real, Real, Real)> &u_xy): dofs{mesh.dofs()}, p{mesh.p()}, q{mesh.q()}, h{mesh.h()}, t{mesh.t()} {
